...
import (
	...
	index "victord/daemon/internal/entity/index"
...
// DestroyIndex mocks base method.
func (m *MockIndexService) DestroyIndex(ctx context.Context, name string) (*index.DestroyIndexResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DestroyIndex", ctx, name)
	ret0, _ := ret[0].(*index.DestroyIndexResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// DestroyIndex indicates an expected call of DestroyIndex.
func (mr *MockIndexServiceMockRecorder) DestroyIndex(ctx, name interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DestroyIndex", reflect.TypeOf((*MockIndexService)(nil).DestroyIndex), ctx, name)
}
