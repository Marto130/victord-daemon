...
func (m *MockVectorOps) DestroyIndex() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "DestroyIndex")
}

// DestroyIndex indicates an expected call of DestroyIndex.
func (mr *MockVectorOpsMockRecorder) DestroyIndex() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DestroyIndex", reflect.TypeOf((*MockVectorOps)(nil).DestroyIndex))
}
